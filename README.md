...
First, the approaches that we differentiate the demand scenarios are very simple, while the decision makers may use their domain knowledge about shoes selling market to find a better method for clustering of categorizing them.
Second, our the methodology and be extended by adding the delivery time as a decision variable, or considering shortage cost.
